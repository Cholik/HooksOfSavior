 ...
 *  @version	:   1.6
 *
 *  Ztring offer a set of string and files manipulations functionalities.
 *
 *  Changelog :
 *
 *		[+] 1.1
 ...
 *
 *	  [+] 1.4
 *		  [FIX]	   str_replace and search algorithms optimization
 *
 *	  [+] 1.5
 *		  [RMV]	   file_is_word_exists removed (bugged)
 *		  [FIX]	   str_pos works now like the php function and not like strstr from C
 *		  [ADD]	   str_explode
 *		  [ADD]	   file_get_size
 *
 *	  [+] 1.6			 (10 / 01 / 2012)
